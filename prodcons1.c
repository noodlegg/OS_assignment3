...
/* condition variable used to signal consumer */
static pthread_cond_t cons_cond = PTHREAD_COND_INITIALIZER;

/* condition variable buffer is empty */
static pthread_cond_t buffer_empty = PTHREAD_COND_INITIALIZER;

/* condition variable buffer is full */
static pthread_cond_t buffer_full = PTHREAD_COND_INITIALIZER

/* condition variable to signal the various producers */
static pthread_cond_t prod_cond[NROF_PRODUCERS];
